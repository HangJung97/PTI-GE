...
def resize_dataset(data_dir: Union[Path, str]) -> None:
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Resizing CAMUS dataset to 64x64.")
    parser.add_argument(
        "-d",
        "--data_dir",
        type=Path,
